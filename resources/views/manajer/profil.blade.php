                    ...
                    <div class="card pb-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="{{ $profil->nama_user }}" name="nama"
                                    id="nama" required>
                            </div>
                            <div class="form-group">
                                <label for="email" class="form-control-label">Email</label>
                                <input class="form-control" type="email" value="{{ $profil->email }}" name="email"
                                    id="email" required>
                            </div>
                            <div class="form-group">
                                <label for="password" class="form-control-label">Password lama <small
                            ...
                            <div class="form-group">
                                <label for="password_new_confirmation" class="form-control-label">
                                    Konfirmasi password baru
                                </label>
                                <input class="form-control" type="password" name="password_new_confirmation"
                                    id="password_new_confirmation" minlength="5">
                                <div class="invalid-feedback d-block" id="password-match-error" style="display:none;"></div>
