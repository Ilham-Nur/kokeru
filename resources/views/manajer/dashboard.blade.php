...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-5 text-right mb-2">
            <a title="Previous" href="#carouselExampleIndicators" role="button" data-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="sr-only">Previous</span>
            </a>
            <a title="Next" href="#carouselExampleIndicators" role="button" data-slide="next">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card card-stats">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <h5 class="card-title text-uppercase text-muted mb-0"> Cleaning Service</h5>
        ...
        <div class="col-xl-12">
            <div class="col-xl-8 col-lg-9 col-md-10 mx-auto mb-3 mt-2">
                <form action="" method="GET">
                    <div class="input-group">
                        ...
                        <input type="text" name="search" class="form-control border-left-0"
                            placeholder="Cari nama ruang atau CS..." value="{{ request('search') }}">
                                                            ...
                                                            <div class="col-xl-2 col-md-3 col-sm-3 col-xs-6 pb-0">
                                                                <div class="card card-stats shadow pb-0">
                                                                    ...
                                                                    <div class="card-body bg-gradient-red">
                                                                        <div class="row">
                                                                            <div class="col text-center">
                                                                                <span class="font-weight-bold mb-0 text-white">BELUM
                                                                                    BERSIH</span><br>
                                                                                <span class="mb-0 text-white"><small>
                                                                                        <?php
                                        if (isset($r->nama_user)) {
